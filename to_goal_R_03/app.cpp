...
void system_create()
{
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 0]     = new StraRun(StraRun::FRONT, gControl[Control::TO_DOUBLE_SIZE + 0], gLeftMotor, gRightMotor, Run::MID);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 1] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.025, 2);
    gRun[Scenario::TO_DOUBLE_SIZE + 1]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 1], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 1]   = new ColorJudge(gColorDetect);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 2] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 2]     = new StraRun(StraRun::FRONT, gControl[Control::TO_DOUBLE_SIZE + 2], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 2]   = new RunDistJudge(gRunDistDetect);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 3]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 3], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 3]   = new ColorJudge(gColorDetect);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 4] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 4]     = new StraRun(StraRun::FRONT, gControl[Control::TO_DOUBLE_SIZE + 4], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 5]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 5], gLeftMotor, gRightMotor, Run::MID);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 6] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 6]     = new StraRun(StraRun::FRONT, gControl[Control::TO_DOUBLE_SIZE + 6], gLeftMotor, gRightMotor, Run::HIGH);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 7] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 7]     = new StraRun(StraRun::BEHIND, gControl[Control::TO_DOUBLE_SIZE + 7], gLeftMotor, gRightMotor, Run::MID);
     ...
     * 制御方法：旋回角度に近づくたび減速する制御(P)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 8] = new GyroStopP(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 8]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 8], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 8]   = new RotateAngleJudge(RotateAngleJudge::LEFT, gAngleMonitor);
