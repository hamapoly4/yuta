...
void system_create()
{
    ...
    gRun[1]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[1], gLeftMotor, gRightMotor, Run::HIGH_SUPER);
    ...
    gRun[3]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[3], gLeftMotor, gRightMotor, Run::HIGH_SUPER);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 6]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 5], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 7]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 6], gLeftMotor, gRightMotor, Run::MID);
