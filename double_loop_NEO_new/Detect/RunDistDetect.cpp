...
RunDistDetect::RunDistDetect(const Motor& leftmotorencoder, const Motor& rightmotorencoder, unsigned char tire)
    : LeftMotorEncoder(leftmotorencoder), RightMotorEncoder(rightmotorencoder), (tire),
