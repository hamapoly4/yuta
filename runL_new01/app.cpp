...
void system_create()
{
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[1] = new LineTracePD(gHSVMonitor, 40, 0.1, 0.005, 3);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[3] = new LineTracePD(gHSVMonitor, 40, 0.1, 0.005, 3);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[5] = new LineTracePD(gHSVMonitor, 40, 0.1, 0.005, 3);
    gRun[5]     = new LineTraceRun(LineTraceRun::LEFT, gControl[5], gLeftMotor, gRightMotor, Run::HIGH);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[6] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.005, 2);
