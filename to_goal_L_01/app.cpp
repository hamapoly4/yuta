...
void system_create()
{
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 7]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 5], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 8]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 6], gLeftMotor, gRightMotor, Run::MID);
