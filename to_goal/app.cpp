...
void system_create()
{
    ...
    gRun[Scenario::TO_LAP_SIZE + 0]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_LAP_SIZE + 0], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_LAP_SIZE + 0]   = new RotateAngleJudge(RotateAngleJudge::RIGHT, gAngleMonitor);
    ...
    gRun[Scenario::TO_LAP_SIZE + 1]     = new StraRun(gControl[Control::TO_LAP_SIZE + 1], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_LAP_SIZE + 3]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 2], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_LAP_SIZE + 4]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 3], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_LAP_SIZE + 5]     = new StraRun(gControl[Control::TO_LAP_SIZE + 4], gLeftMotor, gRightMotor, Run::HIGH);
    ...
    gRun[Scenario::TO_LAP_SIZE + 7]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_LAP_SIZE + 5], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_LAP_SIZE + 7]   = new RotateAngleJudge(RotateAngleJudge::LEFT, gAngleMonitor);
    ...
    gRun[Scenario::TO_LAP_SIZE + 8]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_LAP_SIZE + 6], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_LAP_SIZE + 9]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_LAP_SIZE + 7], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_LAP_SIZE + 10]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_LAP_SIZE + 8], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_LAP_SIZE + 10]   = new RotateAngleJudge(RotateAngleJudge::LEFT, gAngleMonitor);
    ...
    gRun[Scenario::TO_LAP_SIZE + 11]     = new StraRun(gControl[Control::TO_LAP_SIZE + 9], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_LAP_SIZE + 13]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_LAP_SIZE + 10], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_LAP_SIZE + 13]   = new RotateAngleJudge(RotateAngleJudge::RIGHT, gAngleMonitor);
    ...
    gRun[Scenario::TO_LAP_SIZE + 14]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 11], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_LAP_SIZE + 15]     = new StraRun(gControl[Control::TO_LAP_SIZE + 12], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_LAP_SIZE + 16]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_LAP_SIZE + 13], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_LAP_SIZE + 16]   = new RotateAngleJudge(RotateAngleJudge::RIGHT, gAngleMonitor);
    ...
    gRun[Scenario::TO_LAP_SIZE + 17]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_LAP_SIZE + 14], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_LAP_SIZE + 18]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_LAP_SIZE + 15], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_LAP_SIZE + 18]   = new ColorJudge(gColorDetect);

    /* シーンオブジェクトを動的に確保 */
    for (i = Scenario::TO_LAP_SIZE; i < Scenario::ALL_SIZE; i++)
    {
        gScene[i] = new Scene(gRun[i], gJudge[i]);
    }
     ...
     * 制御方法：旋回角度に近づくたび減速する制御(P)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 0] = new GyroStopP(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 0]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 0], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 0]   = new RotateAngleJudge(RotateAngleJudge::RIGHT, gAngleMonitor);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 1]     = new StraRun(gControl[Control::TO_DOUBLE_SIZE + 1], gLeftMotor, gRightMotor, Run::HIGH);
     ...
     * 制御方法：なし
     * ------------------------------------------------------------*/
    gRun[Scenario::TO_DOUBLE_SIZE + 2]     = new LineSearchRun(gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 2]   = new ColorJudge(gColorDetect);
     ...
     * 制御方法：旋回角度に近づくたび減速する制御(P)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 3] = new GyroStopP(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 3]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 2], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 3]   = new RotateAngleJudge(RotateAngleJudge::LEFT, gAngleMonitor);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 4] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.025, 2);
    gRun[Scenario::TO_DOUBLE_SIZE + 4]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 3], gLeftMotor, gRightMotor, Run::LOW);
    gJudge[Scenario::TO_DOUBLE_SIZE + 4]   = new RunDistJudge(gRunDistDetect);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 5]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 4], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 5]   = new ColorJudge(gColorDetect);
    
    /* ゴールまで走行シナリオオブジェクトを動的に確保 */
    gToGoalScenario = new Scenario(gScene, 26, 31);
