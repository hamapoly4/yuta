...
void system_create()
{
    ...
    gRun[3]     = new LineTraceRunRun(LineTraceRun::RIGHT, gControl[2], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[4]     = new LineTraceRunRun(LineTraceRun::RIGHT, gControl[3], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[8]     = new LineTraceRunRun(LineTraceRun::LEFT, gControl[6], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[9]     = LineTraceRunRun(LineTraceRun::LEFT, gControl[7], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[13]     = new LineTraceRunRun(LineTraceRun::RIGHT, gControl[10], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[14]     = new LineTraceRunRun(LineTraceRun::RIGHT, gControl[11], gLeftMotor, gRightMotor, Run::MID);
...
{
    enum eState { CAPTURE, FIN, };
    static eState state = CAPTURE;
    ...
    if (gScenarioTracer->getState() == ScenarioTracer::INITIAL || ev3_button_is_pressed(ENTER_BUTTON) == true)
    {
        state = FIN;
    }
}
