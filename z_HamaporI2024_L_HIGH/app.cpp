...
void system_create()
{
    ...
    gRun[Scenario::TO_LAP_SIZE + 5]     = new StraRun(StraRun::FRONT, gControl[Control::TO_LAP_SIZE + 4], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 2]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 2], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 2]   = new RotateAngleJudge(RotateAngleJudge::RIGHT, gAngleMonitor);
     ...
     * 制御方法：なし
     * ------------------------------------------------------------*/
    gRun[Scenario::TO_DOUBLE_SIZE + 4]     = new LineSearchRun(gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 5]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 4], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 5]   = new RotateAngleJudge(RotateAngleJudge::LEFT, gAngleMonitor);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 6]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 5], gLeftMotor, gRightMotor, Run::LOW);
    gJudge[Scenario::TO_DOUBLE_SIZE + 6]   = new RunDistJudge(gRunDistDetect);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 7]     = new LineTraceRun(LineTraceRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 6], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 7]   = new ColorJudge(gColorDetect);
    ...
    gToGoalScenario = new Scenario(gScene, 26, 33);
