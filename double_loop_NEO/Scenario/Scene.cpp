	...
	: mcurrent_scene_no(scene_no)
{
	...
	{
		case  0:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(RIGHT, 8);
			break;
		case  1:
		...
		case  3:
			...
			break;
		case  4:
			mJudgeMent[mcurrent_scene_no] = new RunDistJudgeMent(RIGHT, 850);
			break;
		case  6:
		...
		case 12:
			...
			break;
		case 14:
			mJudgeMent[mcurrent_scene_no] = new RunDistJudgeMent(RIGHT, 635);
			break;
		case 16:
			mJudgeMent[mcurrent_scene_no] = new RunDistJudgeMent(BOTH, 100);
			break;
		case 17:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(RIGHT, 8);
			break;
		case 18:
			mJudgeMent[mcurrent_scene_no] = new RunDistJudgeMent(LEFT, 1400);
			break;
		default:
			break;
	}
