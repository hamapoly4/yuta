...
namespace {
    ...
    enum eDire { LEFT, RIGHT, BOTH, };
    enum eColor { BLUE, BLACK, };
    ...
    void system_create()
    {
        ...
        gJudgeMent[0] = new RotateAngleJudgeMent(RIGHT, 5, gJudgeGyro);
        gJudgeMent[4] = new RotateAngleJudgeMent(LEFT, -5, gJudgeGyro);
        gJudgeMent[8] = new RotateAngleJudgeMent(LEFT, -5, gJudgeGyro);
        gJudgeMent[12] = new RotateAngleJudgeMent(RIGHT, 10, gJudgeGyro);

        gJudgeMent[1] = new RunDistJudgeMent(300, gRunDistDetect);
        gJudgeMent[5] = new RunDistJudgeMent(50, gRunDistDetect);
        gJudgeMent[9] = new RunDistJudgeMent(50, gRunDistDetect);
        gJudgeMent[11] = new RunDistJudgeMent(200, gRunDistDetect);
        ...
        gScenario = new Scenario(gScene, gLeftMotorEncoder, gRightMotorEncoder,
                                                gJudgeGyro, gStraRunGyro, gColorDetect);
    }
...
{
    if (gScenario->finish() == true || ev3_button_is_pressed(ENTER) == true)
    {
        wup_tsk(MAIN_TASK);
    }
    else
