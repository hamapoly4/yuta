...
private:
	...
	ev3api::GyroSensor&  mJudgeGyro;
	ev3api::GyroSensor&  mStraRunGyro;
...
public:
	Scenario(Scene* scene[], ev3api::Motor& leftmotorencoder, ev3api::Motor& rightmotorencoder,
				ev3api::GyroSensor& judgegyro, ev3api::GyroSensor& strarungyro, ColorDetect* colordetect);
	void run();
	void switch_scene();
	void reset_device();
	bool finish();
