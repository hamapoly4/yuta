...
void system_create()
{
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 0]     = new StraRun(gControl[Control::TO_DOUBLE_SIZE + 0], gLeftMotor, gRightMotor, Run::HIGH);
     ...
     * 制御方法：旋回角度に近づくたび減速する制御(P)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 1] = new GyroStopP(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 1]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 1], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 1]   = new RotateAngleJudge(RotateAngleJudge::LEFT, gAngleMonitor);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 2]     = new StraRun(gControl[Control::TO_DOUBLE_SIZE + 2], gLeftMotor, gRightMotor, Run::HIGH);
     ...
     * 制御方法：なし
     * ------------------------------------------------------------*/
    gRun[Scenario::TO_DOUBLE_SIZE + 3]     = new LineSearchRun(gLeftMotor, gRightMotor);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 4]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 3], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 4]   = new RotateAngleJudge(RotateAngleJudge::RIGHT, gAngleMonitor);
     ...
     * 制御方法：なし
     * ------------------------------------------------------------*/
    gRun[Scenario::TO_DOUBLE_SIZE + 5]     = new LineSearchRun(gLeftMotor, gRightMotor);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 6]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 4], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 7]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 5], gLeftMotor, gRightMotor, Run::MID);
