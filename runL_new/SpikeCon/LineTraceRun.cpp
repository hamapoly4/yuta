...
LineTraceRun::LineTraceRun(unsigned char edge, unsigned char speed,
	Motor& leftmotor, Motor& rightmotor, PIDcon* PIDconcolor)
	: medge(edge), mspeed(speed), mLeftMotor(leftmotor), mRightMotor(rightmotor), mPIDconColor(PIDconcolor),
{
	if (mspeed == LOW)
	{
		mpwm = 35;
